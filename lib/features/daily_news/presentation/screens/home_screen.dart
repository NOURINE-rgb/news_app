...
import 'package:clean_news_app/core/shared/widgets/category_chips.dart';
...
class _HomePageState extends ConsumerState<HomeScreen> {
  ...
  Widget _buildErrorState(String failureMessage) {
    return Center(
      child: Padding(
